					...
					<div class='fixed-width content'>
						<div>
							<table class='col-12 col-sm-12 col-md-12' style="font-size:15px;">
								<thead>
									<tr >
										<th class='col-1 col-sm-2 col-md-2'>Nazwa samochodu</th>
										<th class='col-1 col-sm-2 col-md-2'>Status</th>
										<th class='col-3 col-sm-2 col-md-3' ></th>
									</tr>
								</thead>
								<tbody><?php
									$result = mysqli_query($conn,"SELECT * FROM auta");
									while($row = mysqli_fetch_assoc($result)){
										...
										$status = $row['status'];
											?><tr>
												...
												<td class="butt">
													<button type="submit" class="editauto btn btn-warning btn-sm" name='kategoria' id="<?php echo $id; ?>">Edytuj</button>
												</td>
											</tr>
											<?php }?>
								</tbody>
					...
					<form action="script.php" method="post" enctype="multipart/form-data">
						<div class="row">
							<div class="col-12 col-sm-12 col-md-12">
								<div class="row" class="">
									<div class="col-12 col-sm-6 col-md-7" style="margin:10px;">
										<label for="Nazwa">Nazwa samochodu</label>
										<input type="text"  placeholder="wpisz nazwe" style="width: 180px;" size = "8" name="Nazwa" id="Nazwa" required />
									</div>
									<div class="col-6 col-sm-3 col-md-3" style="text-align:center; font-size:15px;">
										<input type="submit" name='kategoria' value='Dodaj auto'/>
									</div>
